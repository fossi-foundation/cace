...
class SimHints(tkinter.Toplevel):
    ...
    def __init__(self, parent=None, fontsize=11, *args, **kwargs):
        ...
        self.sframe.stitle = ttk.Label(self.sframe, style="title.TLabel", text="Hints")
        ...
        self.sframe.curparam = ttk.Label(self.sframe, style="title.TLabel", text="None")
        ...
        self.sframe.do_reltol.enable = ttk.Checkbutton(
            self.sframe.do_reltol,
            text="Set reltol",
            variable=self.do_reltol,
        ...
        self.sframe.do_reltol.value.pack(
        ...
        self.sframe.do_rshunt.enable = ttk.Checkbutton(
            self.sframe.do_rshunt,
            text="Use shunt resistance",
            variable=self.do_rshunt,
        ...
        self.sframe.do_rshunt.value.pack(
            side="left", anchor="w", fill="x", expand="true"
        )
        ...
        self.sframe.do_nodeset.enable = ttk.Checkbutton(
            self.sframe.do_nodeset,
            text="Use nodeset",
            variable=self.do_nodeset,
        ...
        self.sframe.do_nodeset.value.pack(
            side="left", anchor="w", fill="x", expand="true"
        )
        ...
        self.do_itl1.set(0)
        self.sframe.do_itl1.enable = ttk.Checkbutton(
            self.sframe.do_itl1,
            text="Set gmin iterations",
            variable=self.do_itl1,
        ...
        self.sframe.do_include.enable = ttk.Checkbutton(
            self.sframe.do_include,
            text="Include netlist",
            variable=self.do_include,
        ...
        self.sframe.do_include.value.pack(
            side="left", anchor="w", fill="x", expand="true"
        )
        ...
        self.sframe.do_method.enable = ttk.Checkbutton(
            self.sframe.do_method,
            text="Use alternate method",
            variable=self.do_method,
        ...
        self.sframe.do_method.value.pack(
            side="left", anchor="w", fill="x", expand="true"
        )
