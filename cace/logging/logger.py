...
def register_additional_handler(handler: logging.Handler):
    """
    Adds a new handler to the default CACE logger.
...
def deregister_additional_handler(handler: logging.Handler):
    """
    Removes a registered handler from the default CACE logger.
...
def set_log_level(lv: Union[str, int]):
    """
    Sets the log level of the default CACE logger.
...
def get_log_level() -> int:
    """
    Obtains the numeric log level of the CACE logger.
    """
...
def info(msg: object, /, **kwargs):
    """
    Logs to the CACE logger with the log level INFO.
...
def warn(msg: object, /, **kwargs):
    """
    Logs to the CACE logger with the log level WARNING.
...
def err(msg: object, /, **kwargs):
    """
    Logs to the CACE logger with the log level ERROR.
