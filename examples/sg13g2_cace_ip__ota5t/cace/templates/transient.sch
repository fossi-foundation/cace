...
N 690 420 710 420 {
lab=GND}
C {devices/code_shown.sym} 880 430 0 0 {name=CONTROL only_toplevel=false value="
.control
...
C {sg13g2_cace_ip__ota5t.sym} 610 120 0 0 {name=x2}
...
C {devices/code_shown.sym} 880 220 0 0 {name=SETUP
simulator=ngspice
only_toplevel=false
value="
...
.option warn=1
"}
C {devices/code_shown.sym} 880 50 0 0 {
name=TT_MODELS
only_toplevel=true
value="
** IHP models
